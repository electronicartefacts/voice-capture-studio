...
| Découpe lexicale | Chercheur, monteur, linguiste, créateur de dataset               | Transformer un média parlé en extraits audio mot par mot                          | Audio ou vidéo locale, langue parlée                             | Décodage de la seule piste audio, transcription et horodatage Whisper entièrement locaux                  | ZIP de WAV, manifeste JSON et timeline CSV                               | Chaque mot détecté possède un extrait audio relié à ses bornes temporelles                |
