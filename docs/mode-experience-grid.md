...
| Découpe lexicale | Chercheur, monteur, linguiste, créateur de dataset               | Transformer une voix parlée ou chantée en extraits audio mot par mot              | Audio ou vidéo locale, langue et performance vocale              | Analyse locale secondaire, validation vocale adaptative, puis écoute mot par mot sur l'original           | ZIP de WAV, manifeste JSON enrichi et timeline CSV                       | Chaque mot est vérifiable avec son timecode et sa preuve; le chant n'est pas rejeté par un VAD de parole |
