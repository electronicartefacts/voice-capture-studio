...
| Découpe lexicale | Chercheur, monteur, linguiste, créateur de dataset               | Transformer une voix parlée ou chantée en extraits audio mot par mot              | Audio ou vidéo locale, langue et performance vocale              | Analyse locale secondaire, validation vocale adaptative et profil automatique                             | ZIP de WAV, manifeste JSON enrichi et timeline CSV                       | Chaque hypothèse garde son niveau de preuve; le chant n'est pas rejeté par un VAD de parole |
